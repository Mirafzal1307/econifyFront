        ...
        <div px="5 sm:10 md:12 lg:5" class="max-w-7xl mx-auto flex flex-col items-start gap-10 xl-gap-14">
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div v-for="index in 6" :key="index"
                    class="p-6 bg-neutral-1 dark:bg-neutral-9 rounded-3xl border border-neutral-2 dark:border-neutral-8 shadow-lg relative overflow-hidden">
                    <!-- Image Section -->
                    <img src="https://img.freepik.com/premium-photo/beautiful-woman-is-seen-holding-camera-while-strolling-sea_969100-393.jpg"
                        alt="UX review presentations" class="w-full h-64 object-cover rounded-lg">
                    ...
                    <div class="mt-4 flex space-x-2">
                        ...
                        <span
                            class="px-3 py-1 text-sm rounded-full bg-pink-100 text-pink-700 dark:bg-pink-900 dark:text-pink-300">
                            Presentation
                        </span>
                    </div>
                </div>
